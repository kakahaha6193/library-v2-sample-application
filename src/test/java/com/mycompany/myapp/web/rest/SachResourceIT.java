...
class SachResourceIT {
    ...
    private static final String DEFAULT_THELOAI = "AAAAAAAAAA";
    private static final String UPDATED_THELOAI = "BBBBBBBBBB";
    ...
    void createSach() throws Exception {
        ...
        assertThat(testSach.getTheloai()).isEqualTo(DEFAULT_THELOAI);
    ...
    void getAllSaches() throws Exception {
        ...
        restSachMockMvc
            ...
            .andExpect(jsonPath("$.[*].theloai").value(hasItem(DEFAULT_THELOAI)));
    }
    ...
    void getSach() throws Exception {
        ...
        restSachMockMvc
            ...
            .andExpect(jsonPath("$.theloai").value(DEFAULT_THELOAI));
    }
    ...
    void putNewSach() throws Exception {
        ...
        assertThat(testSach.getTheloai()).isEqualTo(UPDATED_THELOAI);
    ...
    void partialUpdateSachWithPatch() throws Exception {
        ...
        partialUpdatedSach.tenSach(UPDATED_TEN_SACH).nganXep(UPDATED_NGAN_XEP).theloai(UPDATED_THELOAI);
    ...
    void searchSach() throws Exception {
        ...
        // Initialize the database
        sachRepository.saveAndFlush(sach);
        when(mockSachSearchRepository.search("id:" + sach.getId(), PageRequest.of(0, 20)))
