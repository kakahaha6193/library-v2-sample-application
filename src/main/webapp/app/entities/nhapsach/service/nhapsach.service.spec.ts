  ...
  describe('Service methods', () => {
    ...
    describe('addNhapsachToCollectionIfMissing', () => {
      ...
      it('should add only unique Nhapsach to an array', () => {
        const nhapsachArray: INhapsach[] = [{ id: 123 }, { id: 456 }, { id: 20776 }];
      ...
      it('should return initial array if no Nhapsach is added', () => {
        const nhapsachCollection: INhapsach[] = [{ id: 123 }];
        expectedResult = service.addNhapsachToCollectionIfMissing(nhapsachCollection, undefined, null);
        expect(expectedResult).toEqual(nhapsachCollection);
      });
    });
  });
