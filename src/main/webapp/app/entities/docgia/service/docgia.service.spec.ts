  ...
  describe('Service methods', () => {
    ...
    describe('addDocgiaToCollectionIfMissing', () => {
      ...
      it('should add only unique Docgia to an array', () => {
        const docgiaArray: IDocgia[] = [{ id: 123 }, { id: 456 }, { id: 64768 }];
      ...
      it('should return initial array if no Docgia is added', () => {
        const docgiaCollection: IDocgia[] = [{ id: 123 }];
        expectedResult = service.addDocgiaToCollectionIfMissing(docgiaCollection, undefined, null);
        expect(expectedResult).toEqual(docgiaCollection);
      });
    });
  });
