  ...
  describe('Service methods', () => {
    ...
    describe('addMuonsachToCollectionIfMissing', () => {
      ...
      it('should add only unique Muonsach to an array', () => {
        const muonsachArray: IMuonsach[] = [{ id: 123 }, { id: 456 }, { id: 88348 }];
      ...
      it('should return initial array if no Muonsach is added', () => {
        const muonsachCollection: IMuonsach[] = [{ id: 123 }];
        expectedResult = service.addMuonsachToCollectionIfMissing(muonsachCollection, undefined, null);
        expect(expectedResult).toEqual(muonsachCollection);
      });
    });
  });
