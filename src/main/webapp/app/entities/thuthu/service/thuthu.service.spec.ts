  ...
  describe('Service methods', () => {
    ...
    describe('addThuthuToCollectionIfMissing', () => {
      ...
      it('should add only unique Thuthu to an array', () => {
        const thuthuArray: IThuthu[] = [{ id: 123 }, { id: 456 }, { id: 44104 }];
      ...
      it('should return initial array if no Thuthu is added', () => {
        const thuthuCollection: IThuthu[] = [{ id: 123 }];
        expectedResult = service.addThuthuToCollectionIfMissing(thuthuCollection, undefined, null);
        expect(expectedResult).toEqual(thuthuCollection);
      });
    });
  });
