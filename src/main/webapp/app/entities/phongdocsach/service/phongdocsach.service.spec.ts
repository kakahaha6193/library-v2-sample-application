  ...
  describe('Service methods', () => {
    ...
    describe('addPhongdocsachToCollectionIfMissing', () => {
      ...
      it('should add only unique Phongdocsach to an array', () => {
        const phongdocsachArray: IPhongdocsach[] = [{ id: 123 }, { id: 456 }, { id: 86158 }];
      ...
      it('should return initial array if no Phongdocsach is added', () => {
        const phongdocsachCollection: IPhongdocsach[] = [{ id: 123 }];
        expectedResult = service.addPhongdocsachToCollectionIfMissing(phongdocsachCollection, undefined, null);
        expect(expectedResult).toEqual(phongdocsachCollection);
      });
    });
  });
