  ...
  describe('Service methods', () => {
    ...
    describe('addThuephongToCollectionIfMissing', () => {
      ...
      it('should add only unique Thuephong to an array', () => {
        const thuephongArray: IThuephong[] = [{ id: 123 }, { id: 456 }, { id: 20735 }];
      ...
      it('should return initial array if no Thuephong is added', () => {
        const thuephongCollection: IThuephong[] = [{ id: 123 }];
        expectedResult = service.addThuephongToCollectionIfMissing(thuephongCollection, undefined, null);
        expect(expectedResult).toEqual(thuephongCollection);
      });
    });
  });
