...
describe('Cuonsach Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should partial update a Cuonsach', () => {
      const patchObject = Object.assign({}, new Cuonsach());
    ...
    describe('addCuonsachToCollectionIfMissing', () => {
      ...
      it('should add only unique Cuonsach to an array', () => {
        const cuonsachArray: ICuonsach[] = [{ id: 123 }, { id: 456 }, { id: 94975 }];
      ...
      it('should return initial array if no Cuonsach is added', () => {
        const cuonsachCollection: ICuonsach[] = [{ id: 123 }];
        expectedResult = service.addCuonsachToCollectionIfMissing(cuonsachCollection, undefined, null);
        expect(expectedResult).toEqual(cuonsachCollection);
      });
    });
  });
