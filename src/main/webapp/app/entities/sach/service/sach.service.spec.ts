  ...
  describe('Service methods', () => {
    ...
    describe('addSachToCollectionIfMissing', () => {
      ...
      it('should add only unique Sach to an array', () => {
        const sachArray: ISach[] = [{ id: 123 }, { id: 456 }, { id: 47732 }];
      ...
      it('should return initial array if no Sach is added', () => {
        const sachCollection: ISach[] = [{ id: 123 }];
        expectedResult = service.addSachToCollectionIfMissing(sachCollection, undefined, null);
        expect(expectedResult).toEqual(sachCollection);
      });
    });
  });
