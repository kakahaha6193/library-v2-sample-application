  ...
  describe('Service methods', () => {
    ...
    describe('addNhaxuatbanToCollectionIfMissing', () => {
      ...
      it('should add only unique Nhaxuatban to an array', () => {
        const nhaxuatbanArray: INhaxuatban[] = [{ id: 123 }, { id: 456 }, { id: 1407 }];
      ...
      it('should return initial array if no Nhaxuatban is added', () => {
        const nhaxuatbanCollection: INhaxuatban[] = [{ id: 123 }];
        expectedResult = service.addNhaxuatbanToCollectionIfMissing(nhaxuatbanCollection, undefined, null);
        expect(expectedResult).toEqual(nhaxuatbanCollection);
      });
    });
  });
