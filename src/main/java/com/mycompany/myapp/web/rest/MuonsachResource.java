...
public class MuonsachResource {
    ...
    public MuonsachResource(MuonsachService muonsachService, MuonsachRepository muonsachRepository) {
    ...
    public ResponseEntity<Muonsach> createMuonsach(@RequestBody Muonsach muonsach) throws URISyntaxException {
        ...
        Muonsach result = muonsachService.save(muonsach);
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/muonsaches/{id}", consumes = { "application/json", "application/merge-patch+json" })
    public ResponseEntity<Muonsach> partialUpdateMuonsach(
        ...
        Optional<Muonsach> result = muonsachService.partialUpdate(muonsach);
    ...
    public ResponseEntity<List<Muonsach>> getAllMuonsaches(Pageable pageable) {
        ...
        Page<Muonsach> page = muonsachService.findAll(pageable);
    ...
    public ResponseEntity<Muonsach> getMuonsach(@PathVariable Long id) {
        ...
        Optional<Muonsach> muonsach = muonsachService.findOne(id);
    ...
    public ResponseEntity<List<Muonsach>> searchMuonsaches(@RequestParam String query, Pageable pageable) {
        ...
        Page<Muonsach> page = muonsachService.search(query, pageable);
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(ServletUriComponentsBuilder.fromCurrentRequest(), page);
        return ResponseEntity.ok().headers(headers).body(page.getContent());
    }
}
